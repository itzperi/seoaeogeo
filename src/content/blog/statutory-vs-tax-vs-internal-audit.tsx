...
export default function Body() {
  return (
    <>
      ...
      <h2>A simple way to check what applies to you</h2>

      <ul>
        <li>Confirm your entity type: statutory audit is mandatory for companies and larger LLPs regardless of turnover</li>
        <li>Check your turnover or gross receipts against the current tax audit threshold under income tax law</li>
        <li>Assess whether your company falls into the category legally required to have internal audit</li>
        <li>Even if not legally required, consider whether internal audit would genuinely add value given your size and complexity</li>
      </ul>
