...
export default function Body() {
  return (
    <>
      ...
      <h2>How to avoid the interest penalty</h2>
      ...
      <ul>
        <li>Confirm whether your expected tax liability after TDS crosses the advance tax threshold</li>
        <li>Mark all four installment dates on your calendar at the start of the financial year</li>
        <li>Recalculate your estimated income before each installment rather than assuming</li>
        <li>Keep records of what was paid and when, to reconcile against interest calculations later</li>
      </ul>
