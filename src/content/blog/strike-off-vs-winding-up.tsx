...
export default function Body() {
  return (
    <>
      ...
      <h2>Why you cannot always choose strike off</h2>
      ...
      <ul>
        <li>Does the company have any outstanding assets or liabilities</li>
        <li>Are all annual filings and tax returns up to date, or is there a backlog to clear first</li>
        <li>Has the company been genuinely inactive for the period required for strike off eligibility</li>
        <li>Are there any pending disputes, contracts, or creditor claims that need formal resolution</li>
      </ul>
