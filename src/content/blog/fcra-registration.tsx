...
export default function Body() {
  return (
    <>
      ...
      <h2>Why FCRA exists and who it applies to</h2>
      ...
      <h2>Ongoing compliance after registration</h2>
      ...
      <h2>A checklist before applying</h2>

      <ul>
        <li>Confirm your organization meets the minimum existence and expenditure history requirements</li>
        <li>Ensure your trust, society, or Section 8 company registration is current and compliant</li>
        <li>Open the mandatory FCRA account at the designated bank branch before applying</li>
        <li>Plan for annual return filing and separate accounting from the start, not as an afterthought</li>
      </ul>
