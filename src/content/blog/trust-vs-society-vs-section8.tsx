...
export default function Body() {
  return (
    <>
      ...
      <ul>
        <li>How many people will be actively involved in governance, and do you want elections or continuity</li>
        <li>How large and formal do you expect the organization to become</li>
        <li>Are you planning to seek institutional or foreign funding that might favor stronger governance structures</li>
        <li>How much ongoing compliance can your organization realistically manage</li>
      </ul>
