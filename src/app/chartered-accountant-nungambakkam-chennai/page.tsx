  ...
  return (
    <AreaPageTemplate
      ...
      relevantServices={[
        ...
        { slug: "bookkeeping-services-chennai", why: "Monthly books close and MIS reporting for Nungambakkam's established, mid-sized companies." },
        { slug: "payroll-services-chennai", why: "Payroll outsourcing and compliance for Nungambakkam's corporate office staff." },
      ]}
      faqs={[
