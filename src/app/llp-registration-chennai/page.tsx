...
export default function Page() {
  return (
    <ServicePageTemplate
      ...
      relatedQuestions={[
        { question: "Should I choose an LLP or a different entity structure?", href: "/formation-of-business-entity" },
        { question: "How does LLP registration compare to company registration?", href: "/company-registration-chennai" },
        { question: "What does Private Limited incorporation involve if I change my mind later?", href: "/private-limited-company-incorporation-chennai" },
      ]}
