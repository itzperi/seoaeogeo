...
export function organizationSchema() {
  return {
    ...
    url: SITE_URL,
    // Generated by src/app/logo/route.tsx to match the on-page <Logo /> mark
    // exactly — replace with a real designed logo file the moment one
    // exists, but this genuinely resolves (unlike the placeholder before it).
    logo: `${SITE_URL}/logo`,
    image: `${SITE_URL}/logo`,
    telephone: PHONE_TEL,
    email: EMAIL,
